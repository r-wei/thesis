...
\bibitem{GJ} Getzler, E. $\&$ Jones, J. D. S. (1994). Operads, homotopy algebra, and iterated integrals for double loop spaces. Retrieved from arxiv.org/pdf/hep-th/9403055v1.pdf

\bibitem{GV} Gerstenhaber, M., $\&$ Voronov, A. A. (1995). Higher operations on the Hochschild complex. \textit{Functional Anal. Appl. 29}(1), 1-6.
...
\bibitem{Ka} Kadeishvili, T. V. (1988). The structure of the A(∞)-algebra, and the Hochschild and Harrison cohomologies, \textit{Proc. of A. Razmadze Math. Inst., 91}, 20–27.
