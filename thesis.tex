...
pb_pf_adj/adjunction, pb_pf_adj/maps_lambda_shriek}	% chapters to include if you are 
...
\chapter{A homotopically cyclic object in (dg cocategories, dg comodules)}
	\section{$\Lambda_\infty$, a resolution of the cyclic category}
	\section{Coordinate-free version, a sheaf}
